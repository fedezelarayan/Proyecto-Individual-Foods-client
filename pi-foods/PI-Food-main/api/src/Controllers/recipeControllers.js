...
const crearRecipe = async (title, image, summary, healthScore, stepByStep, ingredient, diet) => {
    const newRecipes = await Recipe.create({ title, image, summary, healthScore, stepByStep, ingredient })
